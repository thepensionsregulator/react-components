    ...
    },
    {
      ...
      links: [
        ...
        { 
          ...
          completed: true,
          links: [
            { name: 'Employer Memberships', path: '/employers/employer-membership', completed: true },
            { name: 'Multi-employer scheme structure', path: '/employers/multi-employer-scheme-structure', completed: true, 
              links: [
                { name: 'Employer Memberships', path: '/employers/employer-membership', completed: true },
                { name: 'Multi-employer scheme structure', path: '/employers/multi-employer-scheme-structure', completed: true },
              ]
