...
export const i18n: EmployerI18nProps = {
	...
	remove: {
		confirm: {
			...
			dialog: {
				message1:
					'Removing an employer here does not absolve them of their legal responsabilities. You must ensure that all necessary steps to administer their withdrawal or cessation have been carried out before proceeding.',
