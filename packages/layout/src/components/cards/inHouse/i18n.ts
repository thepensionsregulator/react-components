...
export const i18n: InHouseAdminI18nProps = {
	...
	remove: {
		confirm: {
			...
			dialog: {
				message1:
					'Removing an in house admin here does not absolve them of their legal responsabilities. You must ensure that all necessary steps to administer their withdrawal or cessation have been carried out before proceeding.',
